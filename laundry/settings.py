...
FILE_UPLOAD_HANDLERS = ['utils.progresshandler.UploadProgressCachedHandler', ] \
...
SECRET_KEY = 'mn(_g#)j)0*=@3j5@a&z1@24(h4a#19tnwf+c&dlp=yuc9ut#g'
...
AUTHENTICATION_BACKENDS = [
    'account.backends.AccountAuthBackend',
]
