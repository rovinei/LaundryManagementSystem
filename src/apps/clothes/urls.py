...
urlpatterns = [
    ...
    url(r'^managecloth/laundry/mycloth', views.user_laundry_cloth, name='user_laundry_cloth'),
    ...
    url(r'^managecloth/laundry/remove', views.remove_cloth_from_laundry, name='remove_cloth_from_laundry'),
